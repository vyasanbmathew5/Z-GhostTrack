...
input_user = input(f'\n   {Wh}{Blu}@ Z-Track {Re}~[ + ] : {Gr}') #OPSI MENU
...
if input_user == '1': #OPSI 1
    ...
    stderr.writelines(f"""{Wh}
            {Wh}--------------------------------
           {Wh} | {Gr}DATA - TRACKER - IP ADDRESS {Wh} |
           {Wh} |                              |   
            |{Gr} @CODE BY @vyasanbmathew5     {Wh}|           {Wh}           --------------------------------
 
    """)

    try:
        def IP_Track():
            ip = input(f"{Wh}\n {Blu}Enter Target IP {Re}~[ + ] {Gr}") #INPUT IP ADDRESS
            print()
    ...
    stderr.writelines(f"""{Wh}
            {Wh}--------------------------------
           {Wh} |{Gr}DATA - TRACKER - PHONE NUMBER {Wh}|
           {Wh} |                              |   
            |{Gr} @CODE BY @vyasanbmathew5     {Wh}|           {Wh}           --------------------------------
    ...
    try:
        def phoneGW():
            User_phone = input(f"\n {Blu}Enter Phone Number {Re}~[ + ] {Gr}Ex [+6281xxx] {Wh}: {Gr}") #INPUT NUMBER PHONE
    ...
    stderr.writelines(f"""{Wh}
     {Wh}----------------------------------------
     {Wh}|{Gr}DATA - TRACKER - SHOW YOUR IP ADDRESS {Wh}|
    {Wh} |                                      |   
     |{Gr} @CODE BY @vyasanbmathew5             {Wh}|           {Wh}   ----------------------------------------
    ...
    try:
        def showIP():
            ...
            print(f"\n {Re}[{Gr} + {Re}] {Blu}Your IP Address : {Gr}{Show_IP}")
    ...
    print(f"\n  {Wh}[{Ye}!{Wh}] {Ye}THANKS FOR USING TOOL {Ye}Z-GHOST-TRACK !")
else:
